defmodule Store.V1.PrototypePropertyView do
  ...
  def render("index.json", %{prototype_properties: prototype_properties}) do
    render_many(prototype_properties, Store.V1.PrototypePropertyView, "prototype_property.json")
  end

  def render("show.json", %{prototype_property: prototype_property}) do
    render_one(prototype_property, Store.V1.PrototypePropertyView, "prototype_property.json")
  end
