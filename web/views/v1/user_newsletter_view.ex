defmodule Store.V1.UserNewsletterView do
  ...
  def render("index.json", %{user_newsletters: user_newsletters}) do
    render_many(user_newsletters, Store.V1.UserNewsletterView, "user_newsletter.json")
  end

  def render("show.json", %{user_newsletter: user_newsletter}) do
    render_one(user_newsletter, Store.V1.UserNewsletterView, "user_newsletter.json")
  end
