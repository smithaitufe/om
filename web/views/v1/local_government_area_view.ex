defmodule Store.V1.LocalGovernmentAreaView do
  ...
  def render("index.json", %{local_government_areas: local_government_areas}) do
    render_many(local_government_areas, Store.V1.LocalGovernmentAreaView, "local_government_area.json")
  end

  def render("show.json", %{local_government_area: local_government_area}) do
    render_one(local_government_area, Store.V1.LocalGovernmentAreaView, "local_government_area.json")
  end
