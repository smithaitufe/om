defmodule Store.V1.ReturnAuthorizationView do
  ...
  def render("index.json", %{return_authorizations: return_authorizations}) do
    render_many(return_authorizations, Store.V1.ReturnAuthorizationView, "return_authorization.json")
  end

  def render("show.json", %{return_authorization: return_authorization}) do
    render_one(return_authorization, Store.V1.ReturnAuthorizationView, "return_authorization.json")
  end
