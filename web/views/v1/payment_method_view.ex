defmodule Store.V1.PaymentMethodView do
  ...
  def render("index.json", %{payment_methods: payment_methods}) do
    %{data: render_many(payment_methods, Store.V1.PaymentMethodView, "payment_method.json")}
  end

  def render("show.json", %{payment_method: payment_method}) do
    %{data: render_one(payment_method, Store.V1.PaymentMethodView, "payment_method.json")}
  end
