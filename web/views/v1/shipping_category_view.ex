defmodule Store.V1.ShippingCategoryView do
  ...
  def render("index.json", %{shipping_categories: shipping_categories}) do
    %{data: render_many(shipping_categories, Store.V1.ShippingCategoryView, "shipping_category.json")}
  end

  def render("show.json", %{shipping_category: shipping_category}) do
    %{data: render_one(shipping_category, Store.V1.ShippingCategoryView, "shipping_category.json")}
  end
