defmodule Store.V1.ProductCategoryView do
  ...
  def render("index.json", %{product_categories: product_categories}) do
    render_many(product_categories, Store.V1.ProductCategoryView, "product_category.json")
  end

  def render("show.json", %{product_category: product_category}) do
    render_one(product_category, Store.V1.ProductCategoryView, "product_category.json")
  end
